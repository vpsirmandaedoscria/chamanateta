class ABSpawnPointList
{
	...
	void SetDefaults()
	{
		...
		sp1.Enabled = true;
		sp1.Position = new array<float>();
		sp1.Position.Insert(6824.0);
		sp1.Position.Insert(0.0);
		sp1.Position.Insert(2480.0);
		...
		wp1.Position = new array<float>();
		wp1.Position.Insert(6824.0);
		wp1.Position.Insert(0.0);
		wp1.Position.Insert(2480.0);
		wp1.WaitTime = 5.0;
		sp1.Waypoints.Insert(wp1);
		
		ref ABWaypoint wp2 = new ABWaypoint();
		wp2.Position = new array<float>();
		wp2.Position.Insert(6850.0);
		wp2.Position.Insert(0.0);
		wp2.Position.Insert(2510.0);
		wp2.WaitTime = 5.0;
		sp1.Waypoints.Insert(wp2);
		
		ref ABWaypoint wp3 = new ABWaypoint();
		wp3.Position = new array<float>();
		wp3.Position.Insert(6880.0);
		wp3.Position.Insert(0.0);
		wp3.Position.Insert(2470.0);
		wp3.WaitTime = 5.0;
		...
		sp2.Enabled = true;
		sp2.Position = new array<float>();
		sp2.Position.Insert(10384.0);
		sp2.Position.Insert(0.0);
		sp2.Position.Insert(2254.0);
		sp2.Difficulty = "Hard";
		sp2.GroupSize = 2;
		...
		wp4.Position = new array<float>();
		wp4.Position.Insert(10384.0);
		wp4.Position.Insert(0.0);
		wp4.Position.Insert(2254.0);
		wp4.WaitTime = 10.0;
		sp2.Waypoints.Insert(wp4);
		
		ref ABWaypoint wp5 = new ABWaypoint();
		wp5.Position = new array<float>();
		wp5.Position.Insert(10420.0);
		wp5.Position.Insert(0.0);
		wp5.Position.Insert(2290.0);
		wp5.WaitTime = 10.0;
		...
		sp3.Enabled = true;
		sp3.Position = new array<float>();
		sp3.Position.Insert(8350.0);
		sp3.Position.Insert(0.0);
		sp3.Position.Insert(2500.0);
		sp3.Difficulty = "Easy";
		sp3.GroupSize = 4;
		...
		wp6.Position = new array<float>();
		wp6.Position.Insert(8350.0);
		wp6.Position.Insert(0.0);
		wp6.Position.Insert(2500.0);
		wp6.WaitTime = 8.0;
		sp3.Waypoints.Insert(wp6);
		
		ref ABWaypoint wp7 = new ABWaypoint();
		wp7.Position = new array<float>();
		wp7.Position.Insert(8400.0);
		wp7.Position.Insert(0.0);
		wp7.Position.Insert(2550.0);
		wp7.WaitTime = 8.0;
